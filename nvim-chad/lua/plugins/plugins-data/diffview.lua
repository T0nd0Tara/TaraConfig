...
vim.api.nvim_set_hl(0, 'DiffAdd', { bg = '#246620' })
vim.api.nvim_set_hl(0, 'DiffDelete', { bg = '#662F2F' })
vim.api.nvim_set_hl(0, 'DiffChange', { bg = '#2F4166' })
vim.api.nvim_set_hl(0, 'DiffText', { bg = '#265C4F' })
